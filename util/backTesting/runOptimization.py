...
if __name__ == '__main__':
    ...
    # 设置使用的历史数据库
    engine.setDatabase(MINUTE_DB_NAME, 'IH')
    
    # 跑优化
    setting = OptimizationSetting()  # 新建一个优化任务设置对象
    setting.setOptimizeTarget('capital')  # 设置优化排序的目标是策略净盈利
    setting.addParameter('kkDev', 1, 3, 0.33)  # 增加第一个优化参数atrLength，起始12，结束20，步进2
    setting.addParameter('trailingPrcnt', 0.4, 1.2, 0.2)  # 增加第二个优化参数atrMa，起始20，结束30，步进5
